...
const (
	...
	CodeIsExpiredErr                    = "کد تایید منقضی شده است"
	PhoneNotConfirmedErr                = "این شماره تلفن تایید نشده است"
	WaitingMinutesErr                   = "پس از %s دقیقه میتوانید درخواست دهید"
	NotFoundErr                         = "%s یافت نشد"
	SuccessSendCodeOperation            = "کد تایید ارسال شد"
	...
	SuccessRegisterOperation            = "ثبت نام با موفقیت انجام شد"
